...
export const SETTINGS_SHORTS_KEY = "settings:shorts"
export const SETTINGS_VIDEO_DISPLAY_KEY = "settings:video_display"
export const VIDEO_DISPLAY_DEFAULT = "video"
