const l="settings:extension_enabled",d="settings:comments",y="settings:infinite_scroll",f="settings:description",p="settings:rating_link_clicked",n="settings:extension_installed_at",v="settings:rating_reminder_dismissed_at",_=(e,t,s)=>{chrome.storage.local.set({[e]:t},()=>{s&&s(t)})},r=(e,t)=>{chrome.storage.local.get(e,function(s){t(s)})},D=()=>{r([n],e=>{if(!e[n]){const t=Math.floor(new Date().getTime()/1e3);_(n,t,()=>{})}})},w=()=>{document.cookie="wide=; Max-Age=0; path=/; domain=.youtube.com"},T=()=>{w();const e=new Date;e.setFullYear(e.getFullYear()+1),document.cookie="wide=1; expires="+e.toUTCString()+"; path=/; domain=.youtube.com"},k=(e,t)=>e?!!(e.matches&&e.matches(t)||e.querySelector&&e.querySelector(t)):!1,a=e=>{const t=document.querySelectorAll("ytd-shelf-renderer.style-scope.ytd-item-section-renderer"),s=Array.from(t).find(o=>{const i=o.querySelector("#title");return i?i.innerText.includes(e):!1});s&&s.classList.add("fy-invisible")},g=(e,t,s)=>{new window.MutationObserver(function(i){i[0].addedNodes.length&&Array.from(i[0].addedNodes).some(u=>k(u,t))&&s()}).observe(e,{childList:!0,subtree:!0})},A=()=>{Array.from(document.body.classList).filter(t=>t.startsWith("fy-")).forEach(t=>{document.body.classList.remove(t)})},L=()=>Math.floor(new Date().getTime()/1e3),S=(e,t)=>(t-e)/60/60/24,M=()=>{document.querySelector(".fy-review-reminder")||r([v,p,n],e=>{if(!e[n]||e[p])return;const t=e[v],s=e[n],o=L(),i=t?S(t,o):-1,u=S(s,o),I=90;if(u<=7||i>0&&i<=I)return;const c=document.createElement("div");c.classList="fy-review-reminder",c.innerHTML=`
